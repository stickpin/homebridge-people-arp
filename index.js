...
module.exports = function(homebridge) {
    ...
    homebridge.registerPlatform("homebridge-people-arp", "PeopleARP", PeoplePlatform);
    homebridge.registerAccessory("homebridge-people-arp", "PeopleAccessory", PeopleAccessory);
}
